...
class ControllerExtensionModuleSohtmlcontent extends Controller {
	...
	function getCountdown($setting) {
		...
		$output_html.='<div class="so_countdown">
				<span class="element_container1"><span class="days time_left">'.$day_left.'</span><span class="time_description">'.$curent_value['text_for_day'].'</span></span>
				...
				<span class="t_left">'.$curent_value['text_left'].'</span>
			</div>';		
		$output_html .='</div>';

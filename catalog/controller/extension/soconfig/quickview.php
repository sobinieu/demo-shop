	...
	public function index() {
		...
		if ($product_info) {
			...
			if ($product_info['image']) {
				...
				$data['thumb'] = $this->model_tool_image->resize($placeholder, $this->config->get('theme_' .$this->config->get('config_theme') . '_image_additional_width'), $this->config->get('theme_' .$this->config->get('config_theme') . '_image_additional_height'));
			}

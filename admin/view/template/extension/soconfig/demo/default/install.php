<?php
	...
	$sql ="DROP TABLE IF EXISTS `".DB_PREFIX."so_product_bundles`"; $this->db->query($sql);
	$sql ="DROP TABLE IF EXISTS `".DB_PREFIX."so_product_bundles_activity`"; $this->db->query($sql);
...
if (!$product_lookbook_id->num_rows) {
	...
	$sql = "CREATE TABLE `".DB_PREFIX."so_product_label` (
		`id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
	...
	$sql = "CREATE TABLE `".DB_PREFIX."so_product_bundles` (
		`id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
		`name` text NOT NULL,
		`description` text NOT NULL,
	...
	$sql = "CREATE TABLE `".DB_PREFIX."so_product_bundles_activity` (

	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			// Design
				...
				if ($this->user->hasPermission('access', 'extension/module/so_dashboard')) {   
                  $magentech[] = array(
                    'name'     => 'So Dashboard',
                    'href'     => $this->url->link('extension/module/so_dashboard', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                  );
                }
